...
<cms:template title='Services' ></cms:template>
<!DOCTYPE html>
<html lang="en" class="no-js">
	...
	<body class="layout-content">
		<div id="ip-container" class="ip-container">
			...
			<!-- main content -->
			<div class="bg-abstract services">
				<div class="intro-products">
			    	<h4>LAYANAN KAMI</h4>
			    	<div class="row">
			    		<div class="product-container">
			    			<div class="col s7 l6 right-align top-text">
			    				<cms:editable name='serv_desc' label='Description' desc='Enter description of property here'
						     	type='richtext' />
			    			</div>
			    			<div class="col s5 l6 left-align top-img">
			    				<img src="<cms:editable name='serv_image' label='Image' width='275' show_preview='1' desc='Upload image here' type='image' />"/>
			    			</div>
			    		</div>
			    	</div>
				</div>
				<div class="ip-main">
					<div class="row">
						<ul class="service-prod-1">
							<li><a href="serv-kusen.php"><img src="img/Kusen 1.png"><span>KUSEN</span></a></li>
							<li><a href="serv-facade.php"><img src="img/Facade 1.png"><span>FACADE CURTAIN WALL</span></a></li>
							<li><a href="serv-canopy.php"><img src="img/Canopy 1.png"><span>CANOPY KACA</span></a></li>
							<li><a href="serv-cladding.php"><span>CLADDING ALUMUNIUM COMPOSITE PANEL</span><img src="img/Cladding 1.png"></a></li>
							<li><a href="serv-railing.php"><span>RAILING STAINLESS STEEL</span><img src="img/Railing 1.png"></a></li>
							<li><a href="serv-plafon.php"><span>PLAFON &amp; PARTISI GYPSUM</span><img src="img/Plafon 1.png"></a></li>
						</ul>		         
					</div>
				</div>
